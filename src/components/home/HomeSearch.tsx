    ...
    return (
        <div ref={searchRef} className="max-w-4xl mx-auto px-4 mt-2 mb-0 relative z-[100]">
            <div className={`group relative transform transition-all duration-700 ${isFocused ? 'scale-[1.02]' : 'hover:-translate-y-1'}`}>
                ...
                <div className={`relative flex items-center bg-white dark:bg-[#111111]/80 md:bg-surface/80 backdrop-blur-2xl border transition-all duration-500 rounded-full md:rounded-[3rem] px-5 sm:px-8 py-2.5 md:py-4 ${isFocused ? 'border-primary shadow-premium shadow-primary/10' : 'border-border-subtle/30 md:border-border-subtle shadow-xl'}`}>
                    ...
                    <button
                        ...
                        className="flex items-center justify-center w-10 h-10 md:w-14 md:h-14 rounded-full md:rounded-[2rem] bg-primary/10 dark:bg-[#3a1616]/80 md:bg-primary/10 text-primary hover:bg-primary hover:text-white transition-all duration-500 hover:rotate-12 hover:shadow-[0_0_30px_rgba(220,38,38,0.5)] group/loc shrink-0"
                    >
