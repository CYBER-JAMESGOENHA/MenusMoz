...
export default function MobileBottomNav({ favoritesCount, onPanelOpen }) {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-[1000] md:hidden px-4 pb-4 pt-2 pointer-events-none">
            {/* The main bar */}
            <div className="bg-surface/90 backdrop-blur-xl border border-border-subtle rounded-3xl shadow-premium flex items-center justify-between px-6 py-3 relative pointer-events-auto">
                ...
                >
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest hidden sm:block">Início</span>
                </NavLink>
                ...
                >
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest hidden sm:block">Favs</span>
                </NavLink>
