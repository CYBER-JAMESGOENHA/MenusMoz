...
import { X, Heart, Globe, Moon, Sun, LogIn, LogOut, User, ChevronRight } from 'lucide-react';
...
export default function UserPanel({ 
    ...
    const t = lang === 'pt' ? {
        ...
        favorites_sub: (item: number) => `${item} ${item === 1 ? 'restaurante guardado' : 'restaurantes guardados'}`,
        language: 'Idioma',
        lang_pt: 'Português',
        lang_en: 'English',
        ...
        favorites_sub: (item: number) => `${item} saved ${item === 1 ? 'restaurant' : 'restaurants'}`,
        language: 'Language',
        lang_pt: 'Português',
        lang_en: 'English',
    ...
    return (
        <div className="fixed inset-0 z-[3000]">
            ...
            <div
                ...
                style={{ transform: 'translateX(100%)', paddingBottom: 'env(safe-area-inset-bottom)' }}
            >
                {/* Header */}
