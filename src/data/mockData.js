    ...
    menuCategories: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Peixe da Ilha Grelhado", price: "850 MT", desc: "Posta de peixe do dia with butter sauce and vegetables." },
          { name: "Penne de Frutos do Mar", price: "720 MT", desc: "Pasta with shrimp, squid, and clams in tomato sauce." }
        ]
      },
      {
        name: "Sobremesas",
        items: [
          { name: "Pudim de Leite de Coco", price: "220 MT", desc: "Coconut custard with caramel sauce." },
          { name: "Fruta da Época", price: "150 MT", desc: "Selection of seasonal fruits." },
          { name: "Mousse de Chocolate", price: "180 MT", desc: "Dark chocolate mousse with sea salt." }
        ]
      },
      {
        name: "Bebidas",
        items: [
          { name: "Vinho Branco Alentejo", price: "1.200 MT", desc: "Bottle 750ml — Adega de Portalegre." },
          { name: "Limonada com Hortelã", price: "150 MT", desc: "Home-made fresh lemonade." },
          { name: "Cerveja 2M Imperial", price: "80 MT", desc: "The favorite beer in Maputo." },
          { name: "Água Natural 1.5L", price: "60 MT", desc: "Natural spring water." }
        ]
      }
    ]
  },
